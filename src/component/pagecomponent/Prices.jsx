...
const Prices = () => {
  ...
  return (
    <div className="w-full min-h-screen">
      ...
      <div className="flex flex-col lg:flex-row gap-10 items-center justify-center px-5 lg:px-5 py-10 lg:py-20">
        {pricingPlan.map((price, index) => (
          <PriceCard price={price} index={index} />
        ))}
      </div>
      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-center p-10  gap-5 lg:gap-20">
