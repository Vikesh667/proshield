      ...
      <div className="w-full h-full bg-gradient-to-bl bg-blue-500 to-indigo-500 relative">
        <div className="w-full h-40 flex items-center justify-between px-30">
          ...
          <div className="flex gap-10">
            <span className="group border border-gray-100 p-3 rounded-full flex items-center justify-center hover:bg-white transition-colors duration-300">
              <FaPinterestP className="text-white text-xl group-hover:text-blue-700 hover:!text-blue-500 transition-colors duration-300" />
            </span>
            <span className="group border border-gray-100 p-3 rounded-full flex items-center justify-center hover:bg-white transition-colors duration-300">
              <FaXTwitter className="text-white text-xl group-hover:text-blue-700 hover:!text-blue-500 transition-colors duration-300" />
            </span>
            <span className="group border border-gray-100 p-3 rounded-full flex items-center justify-center hover:bg-white transition-colors duration-300">
              <FaFacebookF className="text-white text-xl group-hover:text-blue-700 hover:!text-blue-500 transition-colors duration-300" />
            </span>
            <span className="group border border-gray-100 p-3 rounded-full flex items-center justify-center hover:bg-white transition-colors duration-300">
              <FaInstagram className="text-white text-xl group-hover:text-blue-700 hover:!text-blue-500 transition-colors duration-300" />
            </span>
          </div>
        </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-4 ">
              <input
                ...
                className="py-5 px-5 w-72 rounded-full bg-white outline-none"
              />
              <button className=" p-4 rounded-full bg-white hover:bg-indigo-950 hover:text-white transform hover:rotate-90 transition duration-500">
