    ...
    <div className="w-full min-h-screen bg-white py-20 px-6 lg:px-24">
      <div className="w-full flex flex-col lg:flex-row gap-10">
        ...
        <div className="lg:w-[30%] w-full flex-shrink-0 flex flex-col gap-10 sticky top-20 self-start h-fit">
          ...
          {/* Contact Info */}
          <div className="bg-gradient-to-r from-indigo-700 to-blue-400 p-10 rounded-2xl flex flex-col gap-5">
            ...
            <div className="flex items-center gap-4">
              <div className="relative">
                ...
                <span className="relative flex w-14 h-14 rounded-full bg-gradient-to-r from-indigo-600 to-blue-400 items-center justify-center z-10">
